...
from intern_stage2_models.backbones.internvideo2 import pretrain_internvideo2_1b_patch14_224
from intern_stage2_models.backbones.bert.builder import build_bert
from intern_stage2_models.criterions import get_sim
from intern_stage2_models.backbones.internvideo2.pos_embed import interpolate_pos_embed_internvideo2_new
from intern_stage2_models.backbones.bert.tokenization_bert import BertTokenizer
...
class InternVideo2_Stage2(nn.Module):
    ...
    def get_vid_feat(self, 
        ...
        with torch.no_grad():  
            ...
            vfeat, _ = self.encode_vision(frames, test=True)
